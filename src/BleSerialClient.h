...
#define ESP_GATT_MAX_ATTR_LEN 512 //orginal 600
...
class BleSerialClient : public BLECharacteristicCallbacks,
						public BLEClientCallbacks,
						public BLEAdvertisedDeviceCallbacks, // this makes problems
						public Stream
{
